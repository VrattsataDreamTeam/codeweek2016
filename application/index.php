...
echo form_open('Test/save_meals#reserve');
...
?>
                                ...
                                <!-- <form class="reservation-form" method="post" action="Test/save_meals#reserve">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="oreder_sum" id="phone" required="required" placeholder="  &#xf095;  Количество">
                                            </div>
                                        </div>
